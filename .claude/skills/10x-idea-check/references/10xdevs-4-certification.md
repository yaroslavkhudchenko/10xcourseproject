🏆 Wszystko o projekcie zaliczeniowym i certyfikacji 10XDevs 4.0
...
W edycji 4.0 kontynuujemy model certyfikacji oparty o 3 składowe:

🚀 10xBuilder (Blok Obowiązkowy) Udana realizacja full-stackowego MVP z wdrożeniem na chmurę. To fundament certyfikacji: każdy uczestnik realizuje ten blok w ramach projektu zaliczeniowego, przerabiając lekcje z modułów 1–3.

🔧 10xArchitect (Blok dla ambitnych) Rozbudowa architektury, modernizacja i refaktoryzacja oraz stosowanie AI w dużej skali. Dla tych, którzy chcą pokazać umiejętności pracy z istniejącymi systemami — realizowany w oparciu o materiał z modułu 3 i 4, dalsza rozbudowa projektu zaliczeniowego lub praca na osobnym projekcie (do wyboru kursanta, szczegóły w pierwszych lekcjach danego modułu).

🏆 10xChampion (Blok dla ambitnych) Opanuj integracje AI w nowoczesnych zespołach programistycznych. Dla tych, którzy chcą udowodnić, że potrafią wdrożyć AI nie tylko w kodzie, ale i w pracy zespołowej (pipeline'y CI/CD) — realizowany w oparciu o materiał z modułu 5, dalsza rozbudowa projektu zaliczeniowego.
...
Dodatek “Wyróżnienie” zyskujesz wysyłając wybrany zakres w 1. terminie, ale wszystkie 3 odznaki można uzyskać nawet w 3 terminie (wtedy certyfikat nie zawiera wyróżnienia, ale nadal jest PRO!).
...
Projekty niewebowe i niestandardowe
Jeśli Twój projekt jest desktopowy, mobilny, embedded lub w innym stacku niż webowy — spokojnie, dostosujemy kryteria oceny do Twojej sytuacji. Nie wymagamy np. publicznego URL od aplikacji desktopowych czy przechodzenia przez płatną certyfikację App Store. Kluczowe jest pokazanie, że przepływ projektowy (dokumentacja, testy, automatyzacja) został zachowany. W razie wątpliwości — opisz swój przypadek w przestrzeni Dyskusje / Praktyka i oznacz prowadzących.

Rozbudowa istniejącego projektu
Możesz certyfikować się na podstawie projektu, nad którym już pracujesz lub który zacząłeś wcześniej — jeśli udowodnisz połączenie między materiałem kursowym (skille, dokumentacja, testy, CI/CD) a tym, co zrobiłeś. Ta ścieżka nie jest 1:1 taka jak w lekcjach, ale nasze skille do planowania i implementacji są w pełni uniwersalne.
...
Prosta reguła: jeśli pierwszy działający przepływ wymaga więcej niż tygodnia pracy po godzinach — zmniejsz MVP. To czujnik dymu. Jeżeli na samo dojście do „czegoś działającego" potrzebujesz kilku tygodni, zabraknie Ci czasu na dokumentację, testy, CI/CD i poprawki po feedbacku.

Najlepiej przyjmowane projekty na poprzednich Demo Days łączyło jedno — były czymś realnym dla twórcy: narzędziem dla znajomych, rozwiązaniem problemu w rodzinie, usprawnieniem własnej pracy. Nie chodzi o podbijanie świata — chodzi o zajawkę i kontekst.
